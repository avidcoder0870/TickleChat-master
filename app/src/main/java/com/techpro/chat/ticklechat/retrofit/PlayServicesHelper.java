...
public class PlayServicesHelper {
    ...
    GenericListener<String> objGenericListener;

    public PlayServicesHelper(Activity activity) {
        this.activity = activity;
    }

    public void registerGcm(GenericListener<String> objGenericListener){
    ...
    private void checkPlayService() {
        ...
        if (checkPlayServices()) {
            ...
            if (regId.isEmpty()) {
                ...
                objGenericListener.onResponse(AppConfigs.DEFAULT_CALLER_ID, regId);
            }
        } else {
    ...
    public String getRegistrationId() {
        ...
        int currentVersion = AppConfigs.getInstance().getAppVersion();
    ...
    private void storeRegistrationId(String regId) {
        final SharedPreferences prefs = getGCMPreferences();
        int appVersion = AppConfigs.getInstance().getAppVersion();
