...
public class LoginDialog extends Dialog implements View.OnClickListener {
    ...
    public LoginDialog(Context context, GenericListener<String> objGenericListener)
    {
        super(context);
        ...
        mEtStatus = (EditText) findViewById(R.id.et_username);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tvPositive:
                objGenericListener.onResponse(R.id.tvPositive, mEtStatus.getText().toString()+"~"+mEtPass.getText().toString());
                break;
        }
    }
}
